...
const MarketingHeader = () => (
  <header className="m-header">
    <div className="m-container m-header-inner">
      ...
      <a className="m-cta" href="https://github.com/josephfung/curia">View on GitHub</a>
    </div>
  </header>
);
...
const ManagedSection = () => (
  <section className="m-section m-section-managed" id="managed">
    <div className="m-container">
  ...
  <footer className="m-footer">
    <div className="m-container">
      <div className="m-footer-grid">
        <div>
          ...
          <div className="m-footer-licence">
            ...
            <span>Open-source · meetcuria.com</span>
          </div>
        </div>
      ...
      <div className="m-footer-finepct">
        <span>© {new Date().getFullYear()} Joseph Fung · meetcuria.com</span>
